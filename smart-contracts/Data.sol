...
contract Data is IData, IndexResolver, DataChunkResolver {
    ...
    function endAuction() public {
        ...
        if(_auctionLider != address(0)){
            _addrOwner.transfer({ value: _auctionPrice*1_000_000_000, flag: 0 });
    ...
    function getMoney() public {
        require(msg.sender == address(0x0eb093156b485497001f06cf5332861b34f306963c2476af5f433fe7050da0a0), Errors.INVALID_CALLER);
