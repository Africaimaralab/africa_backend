...
import pkgSafeMultisigWallet from "../../../../True-NFT/ton-packages/SCMS.package";
import pkgNftRoot from "../../../../True-NFT/ton-packages/NftRootCustomMint.package";
import pkgData from "../../../../True-NFT/ton-packages/Data.package";
import pkgDataChunk from "../../../../True-NFT/ton-packages/DataChunk.package";
...
import config from "../../../../True-NFT/configs/mint.config";
...
export class Mint {
  ...
  async minting(description: string) {
    try {
